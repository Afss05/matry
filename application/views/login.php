...
<form id="rsvp_form3" name="register" class="rsvp_form3 bgc-overlay-white7" action="<?php echo base_url(); ?>user/loginsubmit" method="post" novalidate="novalidate">

<div class="row">
<div class="col-xs-12 col-sm-12 col-md-12 text-center clearfix">
<h1 class="text-thm2 ff-engnmt" >login</h1>
<div class="messages">
...
<button type="submit"  class="btn btn-lg ulockd-btn-thm2 bdrs20">Login</button>
</div>
<div class="form-group text-center">
<p > Have you <a href="<?php echo base_url(); ?>user/forgotuser_password/" > Forgot Your Password ?</a></p>
</div>
</div>
</div>
</form>
