...
$Address=$Name=$CategoryName=$Id=$Email=$Phone=$Description=$StateName=$CityName="";
...
$title="";
if($Id!=""){
	$action=base_url()."Wedding_directory/update_wedding";
	$btn="Update";
	 $title="Update";
}else{
	$action=base_url()."Wedding_directory/add_wedding";
	 $btn="Save";
	 $title="Add";
}
...
<div class="col-sm-4">
<h2><?php echo $title; ?> Wedding Directory </h2>
...
<h5><?php echo $title; ?> Wedding Directory</h5>
...
<h5>Wedding Directory Details  </h5>
</div>
...
<select class="form-control m-b" required name="category">
...
<input name="registername" required  value="<?php echo $Name; ?>" type="text" placeholder="Enter Name" class="form-control">
</div>
</div>

<div class="col-md-4">
<div class="form-group"><label>Email</label> 
<input name="email"  id="email"  maxlength="120" value="<?php echo $Email; ?>" type="email" placeholder="Email" class="form-control">
</div>
</div>
...
<input name="contact_number" id="contact_number" required  oninput="this.value = this.value.replace(/[^0-9]/g, '').replace(/(\..*)\./g, '$1');" maxlength="20" value="<?php echo $Phone;  ?>"  type="text" placeholder="Enter Mobile Number" class="form-control">
</div>
</div>
...
<input name="satename" id="satename" required    value="<?php echo $StateName;  ?>"  type="text" placeholder="Enter State Name" class="form-control">
</div>
</div>
...
<input name="cityname" id="cityname" required    value="<?php echo $CityName;  ?>"  type="text" placeholder="Enter City Name" class="form-control">
...
<textarea name="location" required placeholder=" location" class="form-control" rows="2" id="location"><?php echo $Address; ?></textarea>
</div>
</div>
...
<textarea name="Description" required placeholder=" Description" class="form-control" rows="2" id="Description"><?php echo $Description; ?></textarea>
</div>
</div>
