...
<input name="email"  id="email" onblur="checkemail(this.value)"  maxlength="120" value="<?php echo $PaymentType; ?>" type="email" placeholder="Email" class="form-control">
</div>
</div>
...
<input name="contact_number" id="contact_number" required  oninput="this.value = this.value.replace(/[^0-9]/g, '').replace(/(\..*)\./g, '$1');" maxlength="20" value="" onblur="checkphone(this.value)" type="text" placeholder="Enter Mobile Number" class="form-control">
</div>
</div>

<div class="col-md-3">
<div class="form-group"><label>Alternative Contact Number </label> 
<input name="alter_contact_number" required  maxlength="20" value="" type="text" placeholder=" Alternative Contact Number" class="form-control">
</div>
</div>
...
<input name="occupation" required id="occupation" maxlength="120" value="" type="text" placeholder="Occupation" class="form-control">
</div>
</div>
...
<input name="joblocation" required id="joblocation" maxlength="120" type="text" placeholder="Location" class="form-control">
</div>
</div>
...
<option value="<?php echo $castid; ?>"  > <?php echo $CasteName; ?> </option>
<?php 
} }
