...
<a><span class="label label-warning">Inactive</span> </a>
</span>
<?php } ?>
...
<span id="chng2btn<?php echo $item2->Id;?>" >
<a><span   onclick="profactive(<?php echo $item2->Id;?>);"  class="label label-warning">By-Admin-Inactive</span> </a>
</span>
<?php } ?>
...
<?php }else{  ?>
 ...
 <a class="btn btn-white btn-sm" href="<?php echo base_url(); ?>adminmain/comment_byadmin/<?php  echo 
$this->chsslibrary->encoder($item2->Id); ?>" title="Write Comments" ><i class="fa fa-pencil"> Comments </i></a>
