			...
			<div class="row">
                ...
                <form action="<?php echo $action; ?>" name="register" method="post" enctype="multipart/form-data">
                    <div class="container-fluid py-4">
                            ...
                            <div class="card-body">
                                <div class="row g-3">
                                    ...
                                    <div class="col-md-3">
                                        ...
                                        <select class="form-select" required name="profilefor">
                                    ...
                                    <div class="col-md-3">
                                        ...
                                        <div class="d-flex gap-2">
                                            <select class="form-select" style="width:30%;" id="day" name="day" required>
                                            ...
                                            <select class="form-select" style="width:32%;" id="month" name="month" required>
                                            ...
                                            <select class="form-select" style="width:35%;" id="dobyear" name="dobyear" required>
                                    ...
                                    <div class="col-md-3">
                                        ...
                                        <input name="contact_number" id="contact_number" required oninput="this.value = this.value.replace(/[^0-9]/g, '').replace(/(\..*)\./g, '$1');" maxlength="20" value="<?php echo $ContactNumber; ?>" onblur="_checkphone(this.value)" type="text" placeholder="Enter Mobile Number" class="form-control">
                                    </div>
                                    <!-- Alternative Contact Number -->
                                    <div class="col-md-3">
                                        <label class="form-label">Alternative Contact Number</label>
                                        <input name="alter_contact_number" required maxlength="20" value="<?php echo $AlternativeNumber; ?>" type="text" placeholder="Alternative Contact Number" class="form-control">
                                    </div>
                                    <!-- State -->
                                    <div class="col-md-3">
                                        <?php 
                                        ...
                                        <select class="form-select" required name="state">
                                            <option value="">select</option>
                                            <?php foreach($state_details as $stateitem1){ ?>
                                    ...
                                    <div class="col-md-3">
                                        ...
                                        <select class="form-select" required name="height">
                                    ...
                                    <div class="col-md-3">
                                        ...
                                        <div>
                                            <div class="form-check form-check-inline">
                                                <input class="form-check-input" type="radio" required value="Normal" id="Normal" name="disability" <?php if($Disability=="Normal"){ echo "checked"; } ?>>
                                                <label class="form-check-label" for="Normal">Normal</label>
                                            </div>
                                            <div class="form-check form-check-inline">
                                                <input class="form-check-input" type="radio" value="Physically challenged" id="Physically" name="disability" <?php if($Disability=="Physically challenged"){ echo "checked"; } ?>>
                                                <label class="form-check-label" for="Physically">Physically challenged</label>
                                            </div>
                                        </div>
                                    </div>
                                    <!-- Marital Status -->
                                    <div class="col-md-3">
                                        ...
                                        <select class="form-select" required name="maritalstatus">
                                            <option value="">select</option>
                                    ...
                                    <div class="col-md-3">
                                        ...
                                        <select class="form-select" onchange="getstar(this.value);" name="rasi">
                                    ...
                                    <div class="col-md-3">
                                        ...
                                        <select class="form-select" id="starid" name="star">
                        ...
                        <div class="card shadow mb-4">
                            <div class="card-header bg-success text-white">
                                <h5 class="mb-0">Religion Details</h5>
                            </div>
                            <div class="card-body">
                                <div class="row g-3">
                                    <!-- Religion -->
                                    <div class="col-md-3">
                                        ...
                                        <select class="form-select" onchange="getcaste(this.value);" required name="religion">
                                            <option value="">select</option>
                                            <?php 
                                    ...
                                    <div class="col-md-3">
                                        ...
                                        <select class="form-select" required name="r_mother">
                                    ...
                                    <div class="col-md-3">
                                        ...
                                        <select class="form-select" id="r_case" name="r_case">
                                            <option value="">Select Caste</option>
                                            <?php if(isset($caste_details) && ($caste_details!="")){
                                    ...
                                    <div class="col-md-3" id="castedosham" style="display:<?php if($ReligionId=="1"){ echo ""; }else{ echo "none"; } ?>;">
                                        ...
                                        <div id="doshamshow" style="display:<?php if($HDossam=="2"){ echo ""; }else{ echo "none"; } ?>;">
                                            <?php  
                                            $HDoshamDetails=""; 
                                            $HDoshamDeta=array();
                                            if($item->HDoshamDetails!="" && $item->HDoshamDetails!="0"){
                            ...
                            <div class="card-body">
                                <div class="row g-3">
                                    ...
                                    <div class="col-md-3">
                                        ...
                                        <select class="form-select" required id="brothers" name="brothers">
                                            <option value="">Select</option>
                                    ...
                                    <div class="col-md-3">
                                        ...
                                        <select class="form-select" required id="sister" name="sister">
                                            <option value="">Select</option>
                            ...
                            <div class="card-body">
                                <div class="row g-3">
                                    ...
                                    <div class="col-md-3">
                                        ...
                                        <select class="form-select" required name="YourEmployed">
                                            <option value="">select</option>
                                    ...
                                    <div class="col-md-3">
                                        ...
                                        <select class="form-select" required name="YourAnnual">
                                            <option value="">select</option>
                                            <?php for($i=3;$i<=29;$i++){ ?>
                                                <option value="<?php echo $i; ?>" <?php if($MonthlyIncome==$i){ echo "selected"; } ?>><?php
                                                    $income_ranges = [
                                                        3=>"0 - 1 Lakh",4=>"1 - 2 Lakhs",5=>"2 - 3 Lakhs",6=>"3 - 4 Lakhs",7=>"4 - 5 Lakhs",
                            ...
                            <div class="card-body">
                                <div class="row g-3">
                                    <div class="col-md-3">
                                        ...
                                        <input type="file" multiple onchange="ValidateSize(this)" name="profile_image[]" id="image-upload" class="form-control">
                                    </div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="card shadow mb-4">
                            <div class="card-header bg-success text-white">
                                <h5 class="mb-0">Horoscope Image</h5>
                            </div>
                            <div class="card-body">
                                <div class="row g-3">
                                    <div class="col-md-3">
                                        <label class="form-label">Horoscope Image</label>
                                        <input type="file" onchange="ValidateSize1(this)" name="horos_image[]" id="horos_image" class="form-control">
                                    </div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="card shadow mb-4">
                            <div class="card-header bg-success text-white">
                                <h5 class="mb-0">Partner Expectation Details</h5>
                            </div>
                            <div class="card-body">
                                <div class="row g-3">
                                    <!--  -->
                                    <?php 
                                        ...
                                        if($item->PMaritalStatus!="" && $item->PMaritalStatus!="0"){
                                            $MaritalStatus=explode(",", $item->PMaritalStatus);
                                        }
                                        $PresentAddress="";
                                    ...
                                    <div class="col-md-3">
                                        <label class="form-label">Qualification</label>
                                        <input name="Pqualification" required id="Pqualification" maxlength="120" value="<?php echo $PQualification; ?>" type="text" placeholder="Qualification" class="form-control">
                                    </div>
                                    <div class="col-md-3">
                                        <label class="form-label">Employed in</label>
                                        <select class="form-select" required name="PEmployed">
                                            <option value="">select</option>
                                    ...
                                    <div class="col-md-3">
                                        <label class="form-label">Annual Income</label>
                                        <select class="form-select" required name="PAnnual">
                                            <option value="">select</option>
                                            <?php for($i=3;$i<=29;$i++){ ?>
                                                <option value="<?php echo $i; ?>" <?php if($PIncome==$i){ echo "selected"; } ?>><?php echo $income_ranges[$i]; ?></option>
                                            <?php } ?>
                                        </select>
                                    </div>
                                    <div class="col-md-3">
                                        <label class="form-label">Caste</label>
                                        <select class="form-select" required name="p_caste">
                                            <option value="">select</option>
                                            <?php if(isset($caste_details) && ($caste_details!="")){
                                                foreach($caste_details as $castede){
                                                    $castid=$castede->Id;
                                    ...
                                    <div class="col-md-3">
                                        ...
                                        <div>
                                            <div class="form-check form-check-inline">
                                                <input class="form-check-input" type="checkbox" value="Unmarried" name="pstatus[]" <?php if(in_array("Unmarried", $MaritalStatus)){ echo 'checked'; } ?> id="PUnmarried">
                                                <label class="form-check-label" for="PUnmarried">Unmarried</label>
                                            </div>
                                            <div class="form-check form-check-inline">
                                                <input class="form-check-input" type="checkbox" value="Married" name="pstatus[]" <?php if(in_array("Married", $MaritalStatus)){ echo 'checked'; } ?> id="PMarried">
                                                <label class="form-check-label" for="PMarried">Married</label>
                                            </div>
                                            <div class="form-check form-check-inline">
                                                <input class="form-check-input" type="checkbox" value="Widow/Widower" name="pstatus[]" <?php if(in_array("Widow/Widower", $MaritalStatus)){ echo 'checked'; } ?> id="PWidow">
                                                <label class="form-check-label" for="PWidow">Widow/Widower</label>
                                            </div>
                                            <div class="form-check form-check-inline">
                                                <input class="form-check-input" type="checkbox" value="Divoce" name="pstatus[]" <?php if(in_array("Divoce", $MaritalStatus)){ echo 'checked'; } ?> id="PDivoce">
                                                <label class="form-check-label" for="PDivoce">Divoce</label>
                                            </div>
                                            <div class="form-check form-check-inline">
                                                <input class="form-check-input" type="checkbox" value="Doesnt Matter" name="pstatus[]" <?php if(in_array("Doesnt Matter", $MaritalStatus)){ echo 'checked'; } ?> id="PDoesnt">
                                                <label class="form-check-label" for="PDoesnt">Doesn't Matter</label>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="col-md-3">
                                        ...
                                        <div class="d-flex gap-2">
                                            <select class="form-select" style="width:40%;" id="Pfromage" name="Pfromage" required>
                                                <option value="0">FromAge</option>
                                                <?php if($item->PFromAge!=""){ ?>
                                                    <option value="<?php echo $item->PFromAge; ?>" selected><?php echo $item->PFromAge; ?></option>
                                                <?php } ?>
                                                <?php for($i=18;$i<=70;$i++){ ?>
                                                    <option value="<?php echo $i; ?>"><?php echo $i; ?></option>
                                                <?php } ?>
                                            </select>
                                            <select class="form-select" style="width:45%;" id="Ptoage" name="Ptoage" required>
                                                <option value="0">To Age</option>
                                                <?php if($item->PToAge!=""){ ?>
                                                    <option value="<?php echo $item->PToAge; ?>" selected><?php echo $item->PToAge; ?></option>
                                                <?php } ?>
                                                <?php for($i=18;$i<=70;$i++){ ?>
                                                    <option value="<?php echo $i; ?>"><?php echo $i; ?></option>
                                                <?php } ?>
                                    ...
                                    <div class="col-md-3">
                                        ...
                                        <div>
                                            <div class="form-check form-check-inline">
                                                <input class="form-check-input" type="radio" <?php if($PJobRequest=="Must"){ echo "checked"; } ?> value="Must" id="Must" name="pjobreq">
                                                <label class="form-check-label" for="Must">Must</label>
                                            </div>
                                            <div class="form-check form-check-inline">
                                                <input class="form-check-input" type="radio" <?php if($PJobRequest=="Optional"){ echo "checked"; } ?> value="Optional" id="Optional" name="pjobreq">
                                                <label class="form-check-label" for="Optional">Optional</label>
                                            </div>
                                            <div class="form-check form-check-inline">
                                                <input class="form-check-input" type="radio" <?php if($PJobRequest=="Not required"){ echo "checked"; } ?> value="Not required" id="not_required" name="pjobreq">
                                    ...
                                    <div class="col-md-3">
                                        ...
                                        <div>
                                            <div class="form-check form-check-inline">
                                                <input class="form-check-input" type="checkbox" value="Vegetarian" <?php if(in_array("Vegetarian", $religious_status)){ echo 'checked'; } ?> name="pdiet[]" id="Vegetarian">
                                                <label class="form-check-label" for="Vegetarian">Vegetarian</label>
                                            </div>
                                            <div class="form-check form-check-inline">
                                                <input class="form-check-input" type="checkbox" value="Non-Vegetarian" <?php if(in_array("Non-Vegetarian", $religious_status)){ echo 'checked'; } ?> name="pdiet[]" id="Sarpa">
                                                <label class="form-check-label" for="Sarpa">Non-Vegetarian</label>
                                            </div>
                                            <div class="form-check form-check-inline">
                                                <input class="form-check-input" type="checkbox" value="Eggetarian" <?php if(in_array("Eggetarian", $religious_status)){ echo 'checked'; } ?> name="pdiet[]" id="Eggetarian">
                                                <label class="form-check-label" for="Eggetarian">Eggetarian</label>
                                            </div>
                                            <div class="form-check form-check-inline">
                                                <input class="form-check-input" type="checkbox" value="Doesnt Matter" <?php if(in_array("Doesnt Matter", $religious_status)){ echo 'checked'; } ?> name="pdiet[]" id="Doesnt">
                                                <label class="form-check-label" for="Doesnt">Doesn't Matter</label>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                <div class="mt-4">
                                    ...
                                    <button class="btn btn-primary" onClick="return valthisform();" name="update" value="<?php if($Id!=""){echo $this->chsslibrary->encoder($Id);} ?>" type="submit">
