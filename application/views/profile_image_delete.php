...
$photodelete=base_url()."profile/user_photo_delete/";

}elseif($from=="ByUser"){
$photodelete=base_url()."userprofile/user_photo_delete/";
}
...
<td>  <img src="<?php echo base_url(); ?>assets/profileimages/<?php echo $FilePath; ?>"  style="width:50%;">
</td>
