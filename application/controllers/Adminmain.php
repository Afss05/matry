...
class adminmain extends CI_Controller
{
    ...
    public function index(){
		...
		// $this->load->view('adminmain/dashboard');
    }
...
$myData = $this->Admin_model->getallmemberrecords();
  ...
  // get data
        ...
        // $header = array('Id','Name', 'ProfileFor', 'Email', 'MemberCode', 'Gender', 'Birthtime', 'Birthplace', 'DOB', 'Age', 'MotherTongue', 'CastName', 'Height', 'Qualification','Occupation', 'MonthlyIncome', 'ContactNumber', 'AlternativeNumber', 'PermenantAddress', 'State', 'City', 'PresentAddress', 'FatherName', 'MotherName', 'AddedDate', 'Star', 'Rasi', 'SubCaste', 'Dosham', 'MaritalStatus', 'Totalviewedcount');
        $header = array('Id','Name', 'ProfileFor', 'Email', 'MemberCode', 'Gender', 'DOB', 'Age', 'MotherTongue', 'CastName','Gothram', 'Height', 'Qualification','Occupation', 'MonthlyIncome', 'ContactNumber', 'AlternativeNumber', 'PermenantAddress', 'State', 'City', 'PresentAddress', 'FatherName', 'MotherName', 'AddedDate', 'Star', 'Rasi', 'SubCaste', 'Dosham', 'MaritalStatus', 'Totalviewedcount');
        fputcsv($file, $header);
