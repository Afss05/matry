...
$myData = $this->Admin_model->getallmemberrecords();
  ...
  // get data
        ...
        $header = array('Id','Name', 'ProfileFor', 'Email', 'MemberCode', 'Gender', 'DOB', 'Age', 'MotherTongue', 'CastName', 'Height', 'Qualification','Occupation', 'MonthlyIncome', 'ContactNumber', 'AlternativeNumber', 'PermenantAddress', 'State', 'City', 'PresentAddress', 'FatherName', 'MotherName', 'AddedDate', 'Rasi', 'Star','Totalviewedcount');
        fputcsv($file, $header);
